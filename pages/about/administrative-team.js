...
import { team, management, president } from '../../data';
...
export default function Home() {
  ...
  return <>
    <SEO
      title="ASE Management Team"
      description="ASE Management Team"
      image="/static/img/bg.png"
    />

    <Navbar />

    <Intro text="ASE Management Team" bg="https://res.cloudinary.com/duczlqzws/image/upload/v1693755513/banners/History_Banner_ch1soz.png"/>
<div className='lg:pt-20   lg:px-16  px-5 mx-auto'>
  
  <div className='flex flex-wrap justify-center -mx-4'>
    {president.map(({ name, department, image, slug }, index) => (
      <div
        key={index}
  ...
  <div className='flex flex-wrap justify-center -mx-4'>
    {management.map(({ name, department, image, slug }, index) => (
      <div
        key={index}
        className='w-full sm:w-1/2 md:w-1/4 lg:w-1/4 p-4'
      >
