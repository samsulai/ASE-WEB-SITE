...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if(campus) setCourses(all_courses.filter(c => {
      ...
      return (c.type === "postgraduate") && (c.campus.includes(country));
    }));
      ...
      <div className='max-w-5xl mx-auto'>
        ...
        <div className='space-y-8'>
          <Heading className="!text-left !text-app-dark">ASE {
            ...
            : campus === "cotonou" ? "Benin"
            : "Nigeria"
          } <br/> Postgraduate Courses</Heading>
...
export async function getStaticPaths(context) {
  ...
  return {
    paths: [
      '/courses/postgraduate/abuja',
      '/courses/postgraduate/abidjan',
      '/courses/postgraduate/cotonou',
    ],
    fallback: false,
  }
